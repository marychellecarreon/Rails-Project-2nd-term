...
class BuysControllerTest < ActionController::TestCase
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post :create, buy: { milk_id: @buy.milk_id, price: @buy.price, purchased_date: @buy.purchased_date, totalprice: @buy.totalprice, user_id: @buy.user_id }
    end
  ...
  test "should update buy" do
    patch :update, id: @buy, buy: { milk_id: @buy.milk_id, price: @buy.price, purchased_date: @buy.purchased_date, totalprice: @buy.totalprice, user_id: @buy.user_id }
    assert_redirected_to buy_path(assigns(:buy))
  end
